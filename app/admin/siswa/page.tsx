...
export default async function StudentsPage() {
  ...
  return <AppShell role={user.role} email={user.email} title="Data Siswa" activeNav="Siswa"><MasterDataManager entity="students" singular="Siswa" title="Manajemen Siswa" description="Kelola data siswa dan paket bimbingannya." rows={rows} detailBasePath="/admin/siswa" fields={[{ key: "full_name", label: "Nama lengkap" }, { key: "student_number", label: "NIS" }, { key: "grade", label: "Kelas" }, { key: "parent_name", label: "Orang tua", table: true }, { key: "package_name", label: "Paket", table: true }, { key: "birth_date", label: "Tanggal lahir", type: "date", table: false }, { key: "school_name", label: "Sekolah", table: false }, { key: "parent_id", label: "Orang tua", type: "select", options: options.parents, table: false }, { key: "package_id", label: "Paket", type: "select", options: options.packages, table: false }, { key: "address", label: "Alamat", type: "textarea", table: false }]} /></AppShell>;
}
